...
Public Class ExistingEmployee
    ...
    Private Sub ExistingEmployee_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        con.Open()
        Dim qry1 As String
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Else
            ...
            End If
            qry = "UPDATE Employee set e_name='" + TextBox1.Text + "',e_gender='" + opt + "',e_contact=" + TextBox2.Text + ",e_email='" + TextBox3.Text + "',e_address='" + TextBox4.Text + "' where e_id=" + ComboBox1.Text + ""
